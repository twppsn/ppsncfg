...
GO
GRANT SELECT, INSERT, UPDATE, DELETE, VIEW CHANGE TRACKING ON [dbo].[ObjT] TO public;
GO
...
GO
CREATE UNIQUE INDEX [idxObjTKeyUserId] ON [dbo].[ObjT] ([ObjKId], [ObjRId], [Key], [Class], [UserId])
GO
